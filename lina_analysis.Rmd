...
y1 <- lm1$coefficients[1] - 150
y2 <- lm1$coefficients[1] + n_prior*lm1$coefficients[2] - 150

x3 = as.Date("07-01-2020", format = "%m-%d-%Y")
x4 = as.Date("04-03-2022", format = "%m-%d-%Y")
y3 = lm1$coefficients[1] + (n_prior+30)*(lm1$coefficients[2] + lm1$coefficients[4]) + lm1$coefficients[3] - 598
y4 = lm1$coefficients[1] + (n_prior+30+n_post)*(lm1$coefficients[2] + lm1$coefficients[4]) + lm1$coefficients[3] - 598
...
y1 <- lm2$coefficients[1] + 3
y2 <- lm2$coefficients[1] + n_prior*lm2$coefficients[2] + 3

y3 = lm2$coefficients[1] + (n_prior+30)*(lm2$coefficients[2] + lm2$coefficients[4]) + lm2$coefficients[3] + 70
y4 = lm2$coefficients[1] + (n_prior+30+n_post)*(lm2$coefficients[2] + lm2$coefficients[4]) + lm2$coefficients[3] + 70
...
y1 <- lm3$coefficients[1] -255
y2 <- lm3$coefficients[1] + n_prior*lm3$coefficients[2] -255

y3 = lm3$coefficients[1] + (n_prior+30)*(lm3$coefficients[2] + lm3$coefficients[4]) + lm3$coefficients[3] -340
y4 = lm3$coefficients[1] + (n_prior+30+n_post)*(lm3$coefficients[2] + lm3$coefficients[4]) + lm3$coefficients[3] -340
...
y1 <- lm4$coefficients[1] +90
y2 <- lm4$coefficients[1] + n_prior*lm4$coefficients[2] +90

y3 = lm4$coefficients[1] + (n_prior+30)*(lm4$coefficients[2]+lm4$coefficients[4]) + lm4$coefficients[3] -565
y4 = lm4$coefficients[1] + (n_prior+30+n_post)*(lm4$coefficients[2]+lm4$coefficients[4]) + lm4$coefficients[3] -565
...
y1 <- lm5$coefficients[1] +8
y2 <- lm5$coefficients[1] + n_prior*lm5$coefficients[2] +8

y3 = lm5$coefficients[1] + (n_prior+30)*(lm5$coefficients[2]+lm5$coefficients[4]) + lm5$coefficients[3] +51
y4 = lm5$coefficients[1] + (n_prior+30+n_post)*(lm5$coefficients[2]+lm5$coefficients[4]) + lm5$coefficients[3] +51
...
y1 <- lm6$coefficients[1] +1750
y2 <- lm6$coefficients[1] + n_prior*lm6$coefficients[2] +1750

y3 = lm6$coefficients[1] + (n_prior+30)*(lm6$coefficients[2] + lm6$coefficients[4]) + lm6$coefficients[3] +13650
y4 = lm6$coefficients[1] + (n_prior+30+n_post)*(lm6$coefficients[2] + lm6$coefficients[4]) + lm6$coefficients[3] +13650
